...
func compactStatusSnapshot(snapshot map[string]any) map[string]any {
	...
	return map[string]any{
		...
		"progress": map[string]any{
			...
			"resource_repair_users":  progress["rest_fallback_users"],
			"enumeration_complete":   progress["enumeration_complete"],
			"remaining_id_positions": progress["remaining_id_positions"],
			"historical_repair": map[string]any{
				"active":                 progress["historical_repair_active"],
				"shards":                 progress["historical_repair_shards"],
				"completed_shards":       progress["historical_repair_shards_completed"],
				"remaining_shards":       progress["historical_repair_shards_remaining"],
				"enumerated_users":       progress["historical_repair_enumerated_users"],
				"remaining_id_positions": progress["historical_repair_remaining_ids"],
			},
