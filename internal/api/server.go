...
func compactStatusSnapshot(snapshot map[string]any) map[string]any {
	...
	return map[string]any{
		...
		"progress": map[string]any{
			...
			"settled_scope":              "GraphQL-null accounts are URL-resource repaired in batches; only unresolved identities use REST",
			"estimate_scope":             "fast scan; see settled_finish_* for full negative-lookup coverage",
		},
		"passes": passes,
		"lookup": lookup,
